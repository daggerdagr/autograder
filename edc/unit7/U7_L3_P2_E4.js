...
function AGTest(outputLog) {
	...
	var listInPascalExists = function() {
        return customBlockContains(pascalName, "list %exp", []);
    }
	...
	var pascalCheckExists = pascalChunk.newTip('Make sure you name your block exactly "' + pascalName + '" and place it in the scripting area.',
        'The "' + pascalName + '" block exists and uses the suggested blocks.');
    ...
    /*pascalCheckExists.newAssertTest(
        listInPascalExists,
        'Testing if the "' + pascalName + '" block uses a list.',
        'The "' + pascalName + '" block uses a list.',
        'Make sure your "' + pascalName + '" block uses a list.',
        1
    );*/
